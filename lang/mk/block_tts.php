...
$string['pluginname'] = 'Синтетизатор на говор';
$string['intro'] = 'Овозможи синтетизирање на говор од текст на македонски јазик.';
$string['opendyslexic_font'] = 'Овозможи';
$string['defaut_font'] = 'Исклучи';
$string['readmore'] = 'Прочитај повеќе...';
...
$string['tts_intro'] = 'This plugin is a tool adapted for Text-to-Speech';
